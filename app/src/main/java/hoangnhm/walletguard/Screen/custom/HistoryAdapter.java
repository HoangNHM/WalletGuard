 ...
 */
public class HistoryAdapter extends ArrayAdapter<AccountContent.AccountItem> {

    Activity mActivity;
    ArrayList<AccountContent.AccountItem> mItemArrayList;

    public HistoryAdapter(Activity activity, ArrayList<AccountContent.AccountItem> itemArrayList) {
        super(activity, R.layout.item_history, itemArrayList);
